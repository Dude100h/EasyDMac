...
class MediaPlayer(ttk.Frame):
    def __init__(self, parent, controller, show_welcome, background):
        ...
        labelframe.pack(fill="both", expand=False, pady=(20, 5), padx=5)
        ...
        app_description.grid(row=0, column=0, padx=(0, 60), pady=(40, 20))

        # Back Button
        back_button = ttk.Button(options_frame,
                                 text="<-",
                                 command=lambda: [show_welcome(), stop(), start_welcome_sound()],
                                 style="PomodoroButton.TButton",
                                 cursor="hand2")
        back_button.grid(row=0, column=1, padx=(0, 10), pady=(40, 15))

        # Add Songs Button
        add_song_button = ttk.Button(options_frame, text="Add Songs", style="PomodoroButton.TButton", command=add_many_songs)
        add_song_button.grid(row=0, column=2, padx=(10, 10), pady=(40, 15))

        # Delete Song Button
        delete_song_button = ttk.Button(options_frame, text="Delete Song", style="PomodoroButton.TButton", command=delete_song)
        delete_song_button.grid(row=0, column=3, padx=(10, 10), pady=(40, 15))
        ...
        delete_all_songs_button.grid(row=0, column=4, padx=(10, 10), pady=(40, 15))
        ...
        volume_frame.grid(row=0, column=1, padx=(10, 30))

        # Create music position slider
        my_slider = ttk.Scale(master_frame, from_=0, to=100, orient=HORIZONTAL, value=0, command=slide, length=860)
        ...
        back_button_image = PhotoImage(file="Assets/Backward.png")
        forward_button_image = PhotoImage(file="Assets/Forward.png")
        play_button_image = PhotoImage(file="Assets/Play.png")
        pause_button_image = PhotoImage(file="Assets/Pause.png")
        stop_button_image = PhotoImage(file="Assets/Stop.png")
