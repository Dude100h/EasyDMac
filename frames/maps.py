...
class Maps(ttk.Frame):  # we are calling super class to make self into the frame
    def __init__(self, parent, controller, show_welcome):
        ...
        # Map widget
        map_widget = tkintermapview.TkinterMapView(map_label, width=800, height=400, corner_radius=0)
        ...
        search_box.grid(row=0, column=0, pady=20, padx=5)
        ...
        remove_marker_button.grid(row=0, column=2, padx=5)
        ...
        remove_all_markers_button.grid(row=0, column=3, padx=5)
        ...
        normal_mode_button = ttk.Button(control_frame,
                                        ...
                                        style="PomodoroButton.TButton",
                                        cursor="hand2")
        normal_mode_button.grid(row=0, column=4, padx=5)
        ...
        satellite_mode_button = ttk.Button(control_frame,
                                           ...
                                           style="PomodoroButton.TButton",
                                           cursor="hand2")
        satellite_mode_button.grid(row=0, column=5, padx=5)
