...
class Timer(ttk.Frame):  # we are calling super class to make self into the frame
    def __init__(self, parent, controller, show_settings, show_chatapp, show_welcome, background):
        ...
        labelframe_1.pack(fill="both", expand=False, pady=(5, 35), padx=5)
        ...
        timer_frame.pack(expand=True, fill="both", pady=(30, 0))   # added padding
        ...
        # Label Frame 2
        labelframe_2 = LabelFrame(labelframe, background=background)
        labelframe_2.pack(fill="both", expand=False, pady=(65, 5), padx=5)

        button_container = ttk.Frame(labelframe_2,
                                     padding=10,
        ...
        self.start_button.grid(row=0, column=0, ipadx=30, ipady=20, pady=(10, 10))
        ...
        self.stop_button.grid(row=0, column=1, ipadx=30, ipady=20, pady=(10, 10))
        ...
        reset_button = ttk.Button(button_container,
                                  ...
                                  style="PomodoroButton.TButton",
                                  cursor="hand2")
        reset_button.grid(row=0, column=2, ipadx=30, ipady=20, pady=(10, 10))
    ...
    def decrement_time(self):   # decrement time function to reducing the time lable
