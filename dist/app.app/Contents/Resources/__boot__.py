...
_recipes_pil_prescript(['FitsImagePlugin', 'PcdImagePlugin', 'ImImagePlugin', 'SpiderImagePlugin', 'JpegImagePlugin', 'PsdImagePlugin', 'MspImagePlugin', 'DdsImagePlugin', 'XpmImagePlugin', 'FliImagePlugin', 'FitsStubImagePlugin', 'MpegImagePlugin', 'BufrStubImagePlugin', 'XVThumbImagePlugin', 'WmfImagePlugin', 'EpsImagePlugin', 'IcnsImagePlugin', 'DcxImagePlugin', 'Jpeg2KImagePlugin', 'FpxImagePlugin', 'IcoImagePlugin', 'GifImagePlugin', 'PalmImagePlugin', 'PixarImagePlugin', 'TgaImagePlugin', 'FtexImagePlugin', 'PngImagePlugin', 'GbrImagePlugin', 'TiffImagePlugin', 'ArgImagePlugin', 'McIdasImagePlugin', 'SunImagePlugin', 'ImtImagePlugin', 'WebPImagePlugin', 'PdfImagePlugin', 'MicImagePlugin', 'Hdf5StubImagePlugin', 'PcxImagePlugin', 'XbmImagePlugin', 'GribStubImagePlugin', 'IptcImagePlugin', 'CurImagePlugin', 'BlpImagePlugin', 'PpmImagePlugin', 'SgiImagePlugin', 'MpoImagePlugin', 'BmpImagePlugin'])
