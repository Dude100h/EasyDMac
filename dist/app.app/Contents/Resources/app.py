...
from frames import Timer, Settings, Chat, Welcome, Intro, MediaPlayer, Start, Maps
...
class PomodoroTimer(tk.Tk):  # class that inherits from tk.Tk
    def __init__(self, *args, **kwargs):
        ...
        style.configure("TimerText.TLabel",
                        ...
                        font="Courier 88")  # countdown time text, for specific element
        ...
        def play_sound_3():
            playsound("PS5 Intro Theme Start Button 2.mp3", block=False)
